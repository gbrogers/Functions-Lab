...
//CODE HERE
function theEliminator(conts, loser) {
...
let totalFrogs = buyChocolateFrogs(16);
...
//CODE HERE
function buyChocolateFrogs2(money) {
  return Math.floor(money / 3);
}
let totalFrogs2 = buyChocolateFrogs2(16);
...
//CODE HERE
function isAscendingCheck(sampleArr) {
...
let arrayIsAscending = isAscendingCheck(sampleArray);
